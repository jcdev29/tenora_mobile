...
class _FileComplaintScreenState extends State<FileComplaintScreen> {
  ...
  Future<void> _submitComplaint() async {
    ...
    try {
      final result = await MockComplaintData.fileComplaint(
      ...
      if (result['success']) {
        ...
        _showError(result['error'] ?? 'Failed to file complaint');
      }
    } catch (e) {
      if (mounted) {
  ...
  void _showSuccessDialog() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          'Your complaint has been submitted successfully. The admin will review it and take necessary action.',
        ),
        actions: [
          ElevatedButton(
            onPressed: () {
              Navigator.of(context).pop(); // Close dialog
              Navigator.of(context).pop(); // Go back to complaints
            },
            child: const Text('OK'),
          ),
        ],
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: Text(
              'Please provide detailed information about your complaint or maintenance request. This helps us respond faster and more effectively.',
              style: Theme.of(
                context,
